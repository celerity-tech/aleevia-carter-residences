...
Your responses will always be in the user's preferred language, while code and technical content will be written in English.

Code and files will always be written in TypeScript, unless the user explicitly requests it.
...
Always use npm as the preferred package manager for installing dependencies and running scripts.

Never use bun, npx, yarn, or other package managers unless explicitly requested by the user or required by project constraints.
